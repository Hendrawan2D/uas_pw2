...
<head>
  ...
  <title>@yield('judul') - Oleh Oleh Tegal</title>
...
<body>
  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="{{url('/')}}" class="logo d-flex align-items-center">
        <img src="{{asset('tema/img/oleh.jpg')}}" alt="">
        <span>OLEH OLEH TEGAL</span>
      </a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="{{url('/Jajanan')}}">Jajanan</a></li>
          <li><a href="{{url('/Pakaian')}}">Pakaian</a></li>
  ...
  <footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <p>Kami Merkomenasikan oleh oleh khas Tegal.</p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Oleh Oleh Tegal</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
