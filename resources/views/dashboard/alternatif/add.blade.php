...
@section('content')
    ...
    <!-- partial -->
      <div class="main-panel">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/alternatif/store"  method="POST" class="forms-sample">
                    @csrf
        ...
        {{-- <form class="forms-sample" action="/alternatif/store" method="POST">
                    @csrf

                    <div class="form-group">
                      <label for="nama">Nama Alternatif</label>
                      <input type="text" class="form-control" id="nama" placeholder="nama" name="nama" required="required">
                    </div>
                    <div class="form-group">
                      <label for="deskripsi">Deskripsi</label>
                      <input type="text" class="form-control" id="deskripsi" placeholder="deskripsi" name="deskripsi" required="required">
                    </div>
                    <div class="form-group">
                      <label for="harga">Harga</label>
                      <input type="text" class="form-control" id="harga" placeholder="harga" name="harga" required="required">
                    </div>
                    <div class="form-group">
                      <label for="kualitas">Kualitas</label>
                      <input type="text" class="form-control" id="kualitas" placeholder="kualitas" name="kualitas" required="required">
                    </div>
                    <div class="form-group">
                      <label for="daya_tahan">Daya Tahan</label>
                      <input type="text" class="form-control" id="daya_tahan" placeholder="daya_tahan" name="daya_tahan" required="required">
                    </div>
                    <div class="form-group">
                      <label for="kemudahan_pengiriman">Kemudahan Pengiriman</label>
                      <input type="text" class="form-control" id="kemudahan_pengiriman" placeholder="kemudahan_pengiriman" name="kemudahan_pengiriman" required="required">
                    </div>
                    <div class="form-check form-check-flat form-check-primary">
                      <label class="form-check-label">
                        <input type="checkbox" class="form-check-input">
